...
/* The I2C_NODE macro links directly to mysensor: mysensor@4a in your overlay! */
...
int main(void) {
    ...
    if (ui_init() != 0) return -1;   // UART UI START

    // Get I2C device specification (Bus + 0x4a Address) from Devicetree
